...
const GOOGLE_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbwiNsfLGAPOc7TmKFyMkJof_RHP9YKJttshUTwMQQwDaTOe0nutEa2dBJEnF7-SOqtZ/exec';
...
Submitted: ${new Date().toLocaleString()}
    ...
    const mailtoLink = `mailto:Blackshear.Tyler@gmail.com?subject=${subject}&body=${body}`;
